        ...
        const fetchTransactions = async ()=>{
            try {
                ...
                if (membershipData.success && transactionsData.success) {
                    ...
                    const uniqueTransactions = combinedData.filter((transaction, index, self)=>index === self.findIndex((t)=>t.bill_no === transaction.bill_no));
...
//# sourceMappingURL=src_components_9e9a79d0._.js.map