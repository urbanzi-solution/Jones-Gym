...
"[project]/.next-internal/server/app/api/edit_user_trainer/route/actions.js [app-rsc] (server actions loader, ecmascript)": (function(__turbopack_context__) {
...
"[project]/src/app/api/edit_user_trainer/route.js [app-route] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
async function POST(request) {
    ...
    try {
        ...
        if (!data.user_id || !data.bill_no || !data.trainer_id || !data.trainer_name) {
            return Response.json({
                success: false,
                message: 'Missing required fields: user_id, bill_no, trainer_id, trainer_name'
            }, {
                status: 400
            });
        }
    ...
    `;
        ...
        if (result.rowCount === 0) {
            return Response.json({
                success: false,
                message: 'No matching transaction found to update trainer'
            }, {
                status: 404
            });
        }
...
//# sourceMappingURL=%5Broot-of-the-server%5D__5fc386ee._.js.map