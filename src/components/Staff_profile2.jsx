    ...
    <div className="p-4 md:p-6 lg:p-10">
      <div className="grid grid-cols-2 gap-4 md:gap-8 md:text-2xl">
        <h2 className="flex gap-2 items-center">
          <FaLocationDot className="text-[#FFDD4A]" /> Thampanoor
        </h2>
        ...
        <h2 className="flex gap-2 items-center">
          <FaPhoneAlt className="text-[#FFDD4A]" /> +91 987654321
        </h2>
        <h2 className="flex gap-2 items-center">
          <span className="text-[#FFDD4A] font-semibold">J.D</span>20-12-2022
        </h2>
      </div>
